  ...
  useEffect(() => {
    const scroll = () => {
      if (scrollRef.current) {
        ...
        // If the scroll reaches half of the scrollable width, reset it
    ...
    // Set up a timer to continuously scroll every 10 milliseconds
  ...
  return (
    <section className="sec1">
      ...
      <div className="image-container" ref={scrollRef}>
        <img src="/images/image latest.jpg" alt="Latest Image" />
        <img src="/images/WhatsApp Image 2024-10-02 at 22.37.07_1d18ffad.jpg" alt="WhatsApp Image" />
